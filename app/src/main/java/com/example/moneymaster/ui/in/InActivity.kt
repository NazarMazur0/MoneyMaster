...
import com.example.moneymaster.databinding.ActivityInBinding
...
class InActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val categoryLayout =  binding.IncategoryLayout
        val category : AutoCompleteTextView = binding.Incategory
        val sumLayout= binding.InsumLayout
        val dateLayout=binding.IndateLayout
        val dateEditText= dateLayout.editText
        val descriptionLayout = binding.IndescriptionLayout
        val buttton=binding.InbuttonOperation
        val dateOnPickListener = {
            ...
            datePicker.addOnPositiveButtonClickListener {selection->
               dateEditText!!.setText(DATE_FORMAT.format(selection))
            }
        ...
        val btnOnClickListener={
            ...
            if(dateValidation&&sumValidation&&categoryValidation) {
                ...
                date.time = DATE_FORMAT.parse(dateEditText.text.toString())!!
                dbHelper.insertOperation(0,category,sum,true,description,date.timeInMillis)
